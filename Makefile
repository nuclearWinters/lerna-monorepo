...
setup:
	docker volume create lerna-node-modules && docker volume create backend-auth-node && docker volume create backend-fintech-mongo && docker volume create backend-fintech-mongo-cron && docker volume create frontend-fintech && docker volume create kafka-mongo && docker volume create grpc-auth-node && docker volume create grpc-fintech-node && docker volume create frontend-fintech
install:
