...
import MyTransactionsQueriesPaginationUser_graphql from './MyTransactionsQueriesPaginationUser.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": MyTransactionsQueriesPaginationUser_graphql,
      "identifierInfo": {
        "identifierField": "id",
