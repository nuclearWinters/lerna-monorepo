...
import AddInvestmentsQueriesPaginationQuery_graphql from './AddInvestmentsQueriesPaginationQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": AddInvestmentsQueriesPaginationQuery_graphql,
      "identifierInfo": {
        "identifierField": "id",
