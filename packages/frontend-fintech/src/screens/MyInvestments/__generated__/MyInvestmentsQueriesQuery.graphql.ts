/**
 * @generated SignedSource<<2c466ba328ef51d6f26dc2ad95043f50>>
...
export type MyInvestmentsQueriesQuery = {
  response: MyInvestmentsQueriesQuery$data;
  variables: MyInvestmentsQueriesQuery$variables;
};
