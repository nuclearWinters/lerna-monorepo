/**
 * @generated SignedSource<<499cd85568e36181ef0c0fd2940349c3>>
...
export type MyLoansQueriesPaginationUser$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"MyLoansQueries_user">;
  } | null | undefined;
};
export type MyLoansQueriesPaginationUser = {
  response: MyLoansQueriesPaginationUser$data;
  variables: MyLoansQueriesPaginationUser$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "MyLoansQueriesPaginationUser",
    "selections": [
      {
        "alias": null,
        "args": (v4/*: any*/),
  ...
  "params": {
    "id": "214184aeecc3791eabe5b58e15f73a8d\r",
    "metadata": {},
    "name": "MyLoansQueriesPaginationUser",
    "operationKind": "query",
    "text": null
