/**
 * @generated SignedSource<<2f6bf4163411708ebbe06bc7255293e0>>
...
export type AddInvestmentsQueriesPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"AddInvestmentsQueries_user">;
  } | null | undefined;
};
export type AddInvestmentsQueriesPaginationQuery = {
  response: AddInvestmentsQueriesPaginationQuery$data;
  variables: AddInvestmentsQueriesPaginationQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "74997cad3da3ce985529fbd30726bd41\r",
    "metadata": {},
    "name": "AddInvestmentsQueriesPaginationQuery",
    "operationKind": "query",
    "text": null
