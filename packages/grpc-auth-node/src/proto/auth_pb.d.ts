...
export class JWTMiddlewareInput extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: JWTMiddlewareInput): JWTMiddlewareInput.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: JWTMiddlewareInput, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): JWTMiddlewareInput;
    static deserializeBinaryFromReader(message: JWTMiddlewareInput, reader: jspb.BinaryReader): JWTMiddlewareInput;
}
...
export class JWTMiddlewarePayload extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: JWTMiddlewarePayload): JWTMiddlewarePayload.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: JWTMiddlewarePayload, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): JWTMiddlewarePayload;
    static deserializeBinaryFromReader(message: JWTMiddlewarePayload, reader: jspb.BinaryReader): JWTMiddlewarePayload;
}
