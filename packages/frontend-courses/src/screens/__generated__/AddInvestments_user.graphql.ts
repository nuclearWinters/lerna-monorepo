/**
 * @generated SignedSource<<a0f1dcacb6027b8adaa941f9dcf19f64>>
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./AddInvestmentsPaginationUser.graphql'),
      "identifierField": "id"
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__AddInvestments_user_loans_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
