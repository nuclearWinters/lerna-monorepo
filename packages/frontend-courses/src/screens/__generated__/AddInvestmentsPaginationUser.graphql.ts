...
export type AddInvestmentsPaginationUser$variables = {
  count?: number | null;
  cursor?: string | null;
  id: string;
};
export type AddInvestmentsPaginationUser$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"AddInvestments_user">;
  } | null;
};
export type AddInvestmentsPaginationUser = {
  response: AddInvestmentsPaginationUser$data;
  variables: AddInvestmentsPaginationUser$variables;
};
